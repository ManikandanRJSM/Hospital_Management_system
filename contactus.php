                ...
                <div class="container" data-scrollax-parent="true">
                    <div class="row slider-text align-items-end">
                        <div class="col-md-7 col-sm-12 ftco-animate mb-5">
                            <p class="breadcrumbs" data-scrollax=" properties: { translateY: '70%', opacity: 1.6}"><span class="mr-2"><a href="patientshome.php">Home</a></span> | <span><a href="patientinfo.php?id=<?php echo $_SESSION['pp_id']; ?>">Personal Information</a></span> | <span class="mr-2"><a href="Logout.php">Logout</a></span></p></p>
                    ...
                    <div class="modal-body">
                        <form action="" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" name="apponame" value="<?php echo $_SESSION['usersessa'];?>" class="form-control" id="appointment_name" placeholder="Full Name">
                            </div>
                            <div class="form-group">
                                <!-- <label for="appointment_email" class="text-black">Email</label> -->
                                <input type="text" name="appomail" value="<?php echo $_SESSION['puname'];?>" class="form-control" id="appointment_email" placeholder="Email">
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
