...
if (isset($_POST['submit'])) {
    ...
    elseif (empty($pwd)) {
        ...
        $exist = "SELECT `E-mail` FROM  `representative` WHERE `E-mail`='" . $email . "'";
        $result_exist = $connection->query($exist);
        if ($result_exist->num_rows == 0) {
            $insert = "INSERT INTO `representative` (`Name`,`E_mail`,`password`,`gender`,`Type`,`mobile`,`Profile`) VALUES ('" . ucfirst($name) . "','" . strtolower($email) . "','" . $pwd . "','" . ucfirst($gender) . "','" . $type . "','" . $mobile . "','".$uniquesavename."')";
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a href="RepLogin.php" class="nav-link">Login</a></li>
                ...
                <div class="container" data-scrollax-parent="true">
                    <div class="row slider-text align-items-end">
                        <div class="col-md-7 col-sm-12 ftco-animate mb-5">
                            ...
                            <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">Medical Representative Registration</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-center mb-5 pb-5">
            <form action="" method="POST" enctype="multipart/form-data">
                <br>
                <input type="text" name ="name" placeholder="Name" value ="<?php echo $_REQUEST['name'] ?>"><br>
                <input type="email" name ="mail" placeholder="E-mail" value ="<?php echo $_REQUEST['mail'] ?>"><br>
                <input type="password" name ="pass" placeholder="Password" value ="<?php echo $_REQUEST['pass'] ?>"><br>
                <h5>Choose Gender</h5>
                ...
                <br><input type="text" name ="mob" placeholder="Mobile" value ="<?php echo $_REQUEST['mob'] ?>"><br>
                Choose Profile
