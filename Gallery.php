                ...
                <div class="container" data-scrollax-parent="true">
                    <div class="row slider-text align-items-end">
                        <div class="col-md-7 col-sm-12 ftco-animate mb-5">
                            <p class="breadcrumbs" data-scrollax=" properties: { translateY: '70%', opacity: 1.6}"><span class="mr-2"><a href="index.php">Home</a></span><!--| <span><a href="index.php">logout</a></span></p>-->
               ...
               <!-- <input type="button" value="Go Back" class="btn btn-primary px-4 py-2" onclick="window.location.href='http://localhost/workphpcode//Hospital/patientshome.php'"/>-->
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    for ($i = 0; $i < $count; $i++) {
                        ...
                        echo '<img src="' . $imagestr . '" alt="HTML5 Icon" style="width:200px;height:200px">';
                    }
                }
                ?>
