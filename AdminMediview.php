...
if ($_REQUEST['remove'] !== 0) {
    $delete = "DELETE FROM  `medinfo` WHERE `m_id`='" . $_REQUEST['remove'] . "'";
                ...
                <div class="container" data-scrollax-parent="true">
                    <div class="row slider-text align-items-end">
                        <div class="col-md-7 col-sm-12 ftco-animate mb-5">
                            ...
                            <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">Medicines details </h1>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <tr>
                               <!-- <td><input type="checkbox" name="check_list[]" value="<?php echo $row['Username']; ?>"></td>-->
                                ...
                                <td>                              
                                    ...
                                    <a class="design" id="removes" onClick= "return funss();" href = "AdminMediview.php?remove=<?php echo $row['m_id']; ?>"> Delete </a>
                                </td>
                            </tr>
                            <?php
                            $counter++;
