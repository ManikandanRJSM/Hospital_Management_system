...
error_reporting(0);
session_start();
$status = "UPDATE `reminder` SET `status`='1' WHERE `status`='0' AND `mail`='" . $_SESSION['puname'] . "'";
...
<p class="breadcrumbs" data-scrollax=" properties: { translateY: '70%', opacity: 1.6}"><span class="mr-2"><a href="patientshome.php">Home</a></span>| <span><a href="index.php">Logout</a></span></p> <!--<span><a href="admininfo.php?id=<?php echo $_SESSION['pp_id']; ?>">Personal Information</a></span></p>-->

                            <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">Reminders</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form action="" method="POST" enctype="multipart/form-data">     
                ...
                <table id="rem" border="4">
                    ...
                    <tbody>
                        <?php
                        include 'DBConfig.php';
                        $selct = "SELECT * FROM `reminder` WHERE `mail`='" . $_SESSION['puname'] . "'";
                        //.//echo  $selct;
                        //exit;
