...
//STATUS UPDATE
$status = "UPDATE `medinfo` SET `status`='1' WHERE `status`='0'";
$connection->query($status);

//delete single
if ($_REQUEST['remove'] !== 0) {
    $delete = "DELETE FROM  `patients` WHERE `p_id`='" . $_REQUEST['remove'] . "'";
    ...
    <body>
                ...
                <div class="container" data-scrollax-parent="true">
                    <div class="row slider-text align-items-end">
                        <div class="col-md-7 col-sm-12 ftco-animate mb-5">
                            <p class="breadcrumbs" data-scrollax=" properties: { translateY: '70%', opacity: 1.6}"><span class="mr-2"><a href="AdminHome.php">Home</a></span> </p>
        ...
        <div class="row justify-content-center mb-5 pb-5">
            <form action="" method="POST" enctype="multipart/form-data"> 
                <br>
                <input type="button" value="Go Back" class="btn btn-primary px-4 py-2" onclick="window.location.href = 'http://localhost/workphpcode//Hospital/AdminHome.php'"/>
                <br><table id="pati" border="4">
                    <thead>
                        <tr>
                            ...
                            <tr>
                               <!-- <td><input type="checkbox" name="check_list[]" value="<?php echo $row['Username']; ?>"></td>-->
                                ...
                                <td>                              
                                    ...
                                    <a class="design" id="removes" onClick= "return funss();" href = "Patient.php?remove=<?php echo $row['p_id']; ?>"> |Delete| </a>
                                    <a class="design"  href = "AssignDoctor.php?assdoc=<?php echo $row['p_id']; ?>"> |Assign Doctor| </a>
                                    <a class="design" href = "SendPrescription.php?sndpre=<?php echo $row['p_id']; ?>"> |Send Prescription| </a>
                                    <a class="design" href = "SendSolu.php?sndsol=<?php echo $row['p_id']; ?>"> |Send Solutions| </a>
                                    <a class="design" href = "SendReminder.php?sndpre=<?php echo $row['p_id']; ?>"> |Send Reminder| </a>
                                </td>
                            </tr>
                            <?php
                            $counter++;
