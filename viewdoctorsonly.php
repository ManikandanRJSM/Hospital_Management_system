...
if ($_REQUEST['remove'] !== 0) {
    $delete = "DELETE FROM  `doctors` WHERE `d_id`='" . $_REQUEST['remove'] . "'";
...
<p class="breadcrumbs" data-scrollax=" properties: { translateY: '70%', opacity: 1.6}"><span class="mr-2"><a href="patientshome.php">Home</a></span> <!--<span><a href="admininfo.php?id=<?php echo $_SESSION["adminid"]; ?>">Personal Information</a></span></p>-->

                            <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">Doctors List</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-center mb-5 pb-5">
            <form action="" method="POST" enctype="multipart/form-data"> 
                ...
                <br>
                <!--<br><table id="doctors" border="4" style= "background-color: #84ed86; color: #761a9b; margin: 0 auto;" >-->
                <br><table id="doctors" border="4" >
                    <thead>
                        <tr>
