...
if ($uid != '') {
    ...
    if (isset($_POST['sndsubmit'])) {
        ...
        if (empty($sol)) {
            $err = 1;
            $error['solutions'] = "*Required Solutions";
        } else {
            $sts = '0';
            $insert = "INSERT INTO `solutions` (`patient_name`,`E_mail`,`Solutions`,`status`) VALUES ('" . ucfirst($name) . "','" . strtolower($mail) . "','" . ucfirst($sol) . "','" . $sts . "')";
            if ($connection->query($insert)) {
                $var = 1;
                $suc['sucss'] = "Solutions Sended Sucessfully";
            } else {
                $var = 0;
                $suc['sucss'] = "Solutions not Sucessfully";
            }
        }
    }
}
    ...
    <body>
                ...
                <div class="container" data-scrollax-parent="true">
                    <div class="row slider-text align-items-end">
                        <div class="col-md-7 col-sm-12 ftco-animate mb-5">
                            ...
                            <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">Send Solutions</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-center mb-5 pb-5">
            <form action="" method="POST" enctype="multipart/form-data">  
                <?php
                if ($_POST['sndsubmit'] == 'Send Solutions') {
                    if ($var = 0) {
                        echo '<span style="color:red;">' . $suc['sucss'] . '</span>';
                    } else {
                        echo '<span style="color:green;">' . $suc['sucss'] . '</span>';
                    }
                }
                ?>
                <br>
                ...
                <textarea name="sol" values=value="<?php echo $_REQUEST['sol'] ?>" rows="4" cols="35" ></textarea><?php
                if ($_POST['sndsubmit'] == 'Send Solutions') {
                    echo '<span style="color:red;">' . $error['solutions'] . '</span>';
                }
                ?>
                <br><input type="submit" name ="sndsubmit" class="btn btn-primary px-4 py-2" value="Send Solutions">
            </form>
        </div>
