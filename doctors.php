    ...
    <body>
        ...
        <div class="row justify-content-center mb-5 pb-5">
            <form action="" method="POST" enctype="multipart/form-data">  
                <br>
                <input type="button" value="Add Doctor" class="btn btn-primary px-4 py-2" onclick="window.location.href='http://localhost/workphpcode//Hospital/AddDoctor.php'" /> <input type="button" value="Go Back" class="btn btn-primary px-4 py-2" onclick="window.location.href='http://localhost/workphpcode//Hospital/AdminHome.php'"/>
                <div class="form-group">             
                    <br><table id="docss" border="4">
                        <thead>
                            <tr>
                                ...
                                <tr>
                                   <!-- <td><input type="checkbox" name="check_list[]" value="<?php echo $row['Username']; ?>"></td>-->
                                    ...
                                    <td>                              
                                        ...
                                        <a href = "http://localhost/workphpcode//Hospital/EditDoc.php?editid=<?php echo $row['d_id'] ?>">Edit |</a>
                                        <a class="design" id="removes" onClick= "return funss();" href = "doctors.php?remove=<?php echo $row['d_id']; ?>"> Delete </a>
                                    </td>
                                </tr>
                                <?php
                                $counter++;
