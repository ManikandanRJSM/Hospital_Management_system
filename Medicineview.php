                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <tr>
                               <!-- <td><input type="checkbox" name="check_list[]" value="<?php echo $row['Username']; ?>"></td>-->
                                ...
                                <td>                              
                                    <a href = "http://localhost/workphpcode//Hospital/EditMedicineinfo.php?editid=<?php echo $row['m_id'] ?>">Edit</a>
                                    <a class="design" id="removes" onClick= "return funss();" href = "Medicineview.php?remove=<?php echo $row['m_id']; ?>"> Delete </a>
                                </td>
                            </tr>
                            <?php
                            $counter++;
