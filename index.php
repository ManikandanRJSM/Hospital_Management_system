...
if (isset($_POST['mkapp'])) {
    ...
    if (empty($appname)) {
        $err = 1;
        $corrres['aaaaa'] = "*Required Name";
        //echo "required all feilds";
    }
    if (empty($appmail)) {
        $err = 1;
        $corrres['ssss'] = "*Required Mail";
        //echo "required all feilds";
    }
    if (empty($appdate)) {
        $err = 1;
        $corrres['ddd'] = "*Required Date";
        //echo "required all feilds";
    }
    if (empty($appgender)) {
        $err = 1;
        $corrres['dddz'] = "*Required Gender";
        //echo "required all feilds";
    }
    if (empty($apptime)) {
        $err = 1;
        $corrres['eee'] = "*Required Time";
        //echo "required all feilds";
    }
    if (empty($appmsg)) {
        $err = 1;
        $corrres['fff'] = "*Required Message";
        //echo "required all feilds";
    }
    if (empty($appname) || empty($appmail) || empty($appdate) || empty($apptime) || empty($appmsg)) {
        $err = 1;
        $corrres['ggg'] = "*Required all feilds";
        //echo "required all feilds";
    } else {
        ...
        if ($connection->query($insert)) {
            $sucsss = 1;
            $corrr['ssss'] = "Appoinment Sucessfully";
            //echo "Appoinment Sucessfully";
        } else {
            $sucsss = 0;
            $corrr['ssss'] = "Appoinment Unsucessfully";
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!--<li class="nav-item"><a href="about.php" class="nav-link">Emergency</a></li>-->
...
<div class="row">
  ...
  <form action="#" class="ftco-animate">
                        ...
                        <form action="" method="POST">
                            ...
                            if ($_POST['mkapp'] == 'Make an Appointment') {
                               /// echo '<span style="color:red;">' . $corrres['aaaaa'] . '</span>';
                                if ($sucsss = 0) {
                                    echo '<span style="color:red;">' . $corrr['ssss'] . '</span>';
                                } else {
                                    echo '<span style="color:green;">' . $corrr['ssss'] . '</span>';
                                }
                            }
                            ?>
                            <div class="form-group">
                                <!-- <label for="appointment_name" class="text-black">Full Name</label> -->
                                <input type="text" name ="apponame" class="form-control" id="appointment_name" value="<?php echo $_REQUEST['apponame']?>"placeholder="Full Name" ><?php if ($_POST['mkapp'] == 'Make an Appointment') {
    echo '<span style="color:red;">' . $corrres['aaaaa'] . '</span>';
} ?>
                            </div>
                            <div class="form-group">
                                <!-- <label for="appointment_email" class="text-black">Email</label> -->
                                <input type="email" name ="appomail" class="form-control" id="appointment_email" value="<?php echo $_REQUEST['appomail']?>" placeholder="Email"><?php if ($_POST['mkapp'] == 'Make an Appointment') {
    echo '<span style="color:red;">' . $corrres['ssss'] . '</span>';} ?>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
    ...
    echo '<span style="color:red;">' . $corrres['ddd'] . '</span>';
} ?>
                                    </div>    
                                </div>
                                <div class="col-md-6">
    ...
    echo '<span style="color:red;">' . $corrres['eee'] . '</span>';
} ?>
                                    </div>
                                </div>
                            </div>
                            <h5>Choose Gender</h5><?php if ($_POST['mkapp'] == 'Make an Appointment') {
    echo '<span style="color:red;">' . $corrres['dddz'] . '</span>';
} ?><br>
    ...
    echo '<span style="color:red;">' . $corrres['fff'] . '</span>';
} ?>
                            </div>
                            <div class="form-group">
