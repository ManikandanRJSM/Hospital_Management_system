...
//STATUS UPDATE
$status = "UPDATE `assigndoctor` SET `status`='1' WHERE `status`='0' AND `E_mail`='" . $_SESSION['puname'] . "'";
...
<p class="breadcrumbs" data-scrollax=" properties: { translateY: '70%', opacity: 1.6}"><span class="mr-2"><a href="patientshome.php">Home</a></span><!-- <span>Services</span></p>-->
                ...
                <form action="" method="POST" enctype="multipart/form-data">               
                    ...
                    <table id="appoint" border="4">
                        ...
                        <tbody>
                            <?php
                            include 'DBConfig.php';
                            $selct = "SELECT * FROM `assigndoctor` WHERE `E_mail`='" . $_SESSION['puname'] . "'";
