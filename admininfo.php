                ...
                <div class="container" data-scrollax-parent="true">
                    <div class="row slider-text align-items-end">
                        <div class="col-md-7 col-sm-12 ftco-animate mb-5">
                            ...
                            <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">HELLOW! <?php error_reporting(0);session_start(); echo $_SESSION['usersess'];?></h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form action="" method="POST" enctype="multipart/form-data">    
                ...
                <table border="4" style= "background-color: #84ed86; color: #761a9b; margin: 0 auto;" >
                    ...
                    <tbody>
                        ...
                        include 'DBConfig.php';
                        $id = $_REQUEST['id'];
                        $selct = "SELECT * FROM `admin` WHERE `id`='".$id."'";
                       //echo $selct;
                       /// exit;
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <tr>
                                ...
                                <td>                              
                                    <a href = "http://localhost/workphpcode//Hospital/admineditinfo.php?editid=<?php echo $_SESSION["adminid"]; ?>">Edit</a>                                    
                                </td>
                            </tr>
                            <?php
