...
//STATUS UPDATE
$status = "UPDATE `appointments` SET `status`='1' WHERE `status`='0'";
$connection->query($status);

//delete single
if ($_REQUEST['remove'] !== 0) {
    $delete = "DELETE FROM  `appointments` WHERE `app_id`='" . $_REQUEST['remove'] . "'";
            ...
            <form action="" method="POST" enctype="multipart/form-data">   
                ...
                <br><table id="Apps" border="4">
                    ...
                    <tbody>
                        <?php
                        include 'DBConfig.php';
                        $selct = "SELECT * FROM appointments";
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <tr>
                                ...
                                <td>                              
                                    ...
                                    <a class="design" id="removes" onClick= "return funss();" href = "Appointments.php?remove=<?php echo $row['app_id']; ?>"> Delete </a>
                                </td>
                            </tr>
                            <?php
                            $counter++;
