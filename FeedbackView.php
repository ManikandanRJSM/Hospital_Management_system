...
//STATUS UPDATE
$status = "UPDATE `feedback` SET `status`='1' WHERE `status`='0'";
$connection->query($status);

//delete single
if ($_REQUEST['remove'] !== 0) {
    $delete = "DELETE FROM  `feedback` WHERE `f_id`='" . $_REQUEST['remove'] . "'";
                ...
                <div class="container" data-scrollax-parent="true">
                    <div class="row slider-text align-items-end">
                        <div class="col-md-7 col-sm-12 ftco-animate mb-5">
                            <p class="breadcrumbs" data-scrollax=" properties: { translateY: '70%', opacity: 1.6}"><span class="mr-2"><a href="AdminHome.php">Home</a></span>| <span><a href="index.php">Services</a></span></p>
                    ...
                    <tbody>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <tr>
                                ...
                                <td>                            
                                    <a class="design" id="removes" onClick= "return funss();" href = "FeedbackView.php?remove=<?php echo $row['f_id']; ?>"> Delete </a>
                                </td>
                            </tr>
                            <?php
                            $counter++;
