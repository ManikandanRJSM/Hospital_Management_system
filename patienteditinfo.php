...
if ($_REQUEST['editid'] !== 0) {
    $selc = "SELECT *FROM `patients` WHERE `p_id`='" . $_REQUEST['editid'] . "'";
    //echo $selc;
    //exit;
...
if (isset($_POST['editsubmit'])) {
    ...
    if (empty($name) || empty($email) || empty($gender) || empty($type) || empty($mob) || empty($add)) {
        ...
        include 'DBConfig.php';
        $edit = "UPDATE `patients` SET `Name`='" . ucfirst($name) . "',`E-mail`='" . strtolower($email) . "',`gender`='" . ucfirst($gender) . "',`type`='" . ucfirst($type) . "',`mobile`='" . $mob . "',`Address`='" . ucfirst($add) . "'" . $proupdate . "  WHERE `p_id`='" . $u_id . "'";
//        echo $edit;
//        exit;
    ...
    <body>
                ...
                <div class="container" data-scrollax-parent="true">
                    <div class="row slider-text align-items-end">
                        <div class="col-md-7 col-sm-12 ftco-animate mb-5">
                            ...
                            <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">Edit Patients</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-center mb-5 pb-5">
            <form action="" method="POST" enctype="multipart/form-data">               
                <br>
                <input type="text" name ="dame" placeholder="Patient Name" value ="<?php
                if ($row['Name'] !== '') {
                    echo $row['Name'];
                } else {
                    echo $_POST['dame'];
                ...
                <input type="text" name ="addr" placeholder="Address" value ="<?php
                if ($row['Address'] !== '') {
                    echo $row['Address'];
                } else {
                    echo $_POST['addr'];
                ...
                foreach ($str2arr as $vale) {
                    ...
                    echo '<img src="profile/' . $vale . '" style="width:75px" />';
                }
                ?><br>
