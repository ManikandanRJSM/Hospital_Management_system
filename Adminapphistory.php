...
if ($_REQUEST['remove'] !== 0) {
    $delete = "DELETE FROM  `assigndoctor` WHERE `ass_id`='" . $_REQUEST['remove'] . "'";
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a href="Appointments.php" class="nav-link">Appointments<?php if($contsum1['sum'] > 0) { ?>
                ...
                <div class="container" data-scrollax-parent="true">
                    <div class="row slider-text align-items-end">
                        <div class="col-md-7 col-sm-12 ftco-animate mb-5">
                            ...
                            <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">Appointments History</h1>
                        </div>
                    </div>
                </div>
            </div>
                  ...
                  <form action="" method="POST" enctype="multipart/form-data">   
                    ...
                    <br><table id="Apps" border="4">
                        ...
                        <tbody>
                            <?php
                            include 'DBConfig.php';
                            $selct = "SELECT * FROM assigndoctor";
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="design" id="removes" onClick= "return funss();" href = "Adminapphistory.php?remove=<?php echo $row['ass_id']; ?>"> Delete </a>
                                    </td>
                                </tr>
                                <?php
                                $counter++;
