...
if(isset($_POST['submit'])){
    ...
    elseif(empty($pwd)){
     ...
     $sql1 = "SELECT *FROM `representative` WHERE `E_mail`='".$email."' AND `password`='".$pwd."'";
    // echo $sql1;
    // exit;
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a href="RepReg.php" class="nav-link">Register</a></li>
                ...
                <div class="container" data-scrollax-parent="true">
                    <div class="row slider-text align-items-end">
                        <div class="col-md-7 col-sm-12 ftco-animate mb-5">
                            ...
                            <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">Representative Login</h1>
                        </div>
                    </div>
                </div>
            </div>
