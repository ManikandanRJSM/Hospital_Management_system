                ...
                <div class="container" data-scrollax-parent="true">
                    <div class="row slider-text align-items-end">
                        <div class="col-md-7 col-sm-12 ftco-animate mb-5">
                            <p class="breadcrumbs" data-scrollax=" properties: { translateY: '70%', opacity: 1.6}"><span class="mr-2"><a href="RepHome.php">Home</a></span> </p>
                            <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">HELLOW! <?php error_reporting(0);session_start(); echo $_SESSION['repname'];?></h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form action="" method="POST" enctype="multipart/form-data">      
                ...
                <table border="4" style= "background-color: #84ed86; color: #761a9b; margin: 0 auto;" >
                    ...
                    <tbody>
                        ...
                        $email = $_REQUEST['select_id'];
                        $selct = "SELECT * FROM `representative` WHERE `E_mail`='".$email."'";
                       //echo $selct;
                       /// exit;
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <tr>
                                ...
                                <td>                              
                                    <a href = "http://localhost/workphpcode//Hospital/repeditinfo.php?editid=<?php echo $row['r_id'] ?>">Edit</a>                                    
                                </td>
                            </tr>
                            <?php
