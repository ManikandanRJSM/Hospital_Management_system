...
error_reporting(0);
session_start();
$status = "UPDATE `solutions` SET `status`='1' WHERE `status`='0' AND `E_mail`='" . $_SESSION['puname'] . "'";
                ...
                <div class="container" data-scrollax-parent="true">
                    <div class="row slider-text align-items-end">
                        <div class="col-md-7 col-sm-12 ftco-animate mb-5">
                            <p class="breadcrumbs" data-scrollax=" properties: { translateY: '70%', opacity: 1.6}"><span class="mr-2"><a href="patientshome.php">Home</a></span> | <span><a href="index.php">Log out</a></span></p>

                            <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">Solutions!</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form action="" method="POST" enctype="multipart/form-data">  
                ...
                <table id="rem" border="4">
                    ...
                    <tbody>
                        <?php
                        include 'DBConfig.php';
                        $selct = "SELECT * FROM `solutions` WHERE `E_mail`='" . $_SESSION['puname'] . "'";
                        //.//echo  $selct;
                        //exit;
