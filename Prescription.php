            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a href="AddPrescriptions.php" class="nav-link">Add Prescriptions</a></li>
                         <!--<li class="nav-item"><a href="AssignDoctor.php" class="nav-link">Assign Doctors</a></li>-->
                            ...
                            <tr>
                               <!-- <td><input type="checkbox" name="check_list[]" value="<?php echo $row['Username']; ?>"></td>-->
                                ...
                                <td>                              
                                    ...
                                    <a class="design" id="removes" onClick= "return funss();" href = "Prescription.php?remove=<?php echo $row['d_id']; ?>"> Delete </a>
                                </td>
                            </tr>
                            <?php
                            $counter++;
