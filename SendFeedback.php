...
if (isset($_POST['feedsubmit'])) {
    ...
    if (empty($name)) {
        ...
        $rrr=0;
        echo "Please enter FeedBack message";
       ...
       $sats ='0';
            ...
            $insert = "INSERT INTO `feedback` (`Name`,`E-mail`,`message`,`status`) VALUES ('" . ucfirst($name) . "','" . strtolower($email) . "','" . $msg . "','" . $sats . "')";
           // echo $insert;
            //exit;
            if ($connection->query($insert)) {
                
                echo "Feedback Sended Sucessfully";
            } else {             
                //echo "<br>";
                //echo "Not registered";
            }
    ...
    <body>
                ...
                <div class="container" data-scrollax-parent="true">
                    <div class="row slider-text align-items-end">
                        <div class="col-md-7 col-sm-12 ftco-animate mb-5">
                            <p class="breadcrumbs" data-scrollax=" properties: { translateY: '70%', opacity: 1.6}"><span class="mr-2"><a href="patientshome.php">Home</a></span> 
                            <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">FeedBack!</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-center mb-5 pb-5">
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <br><textarea name="msg" rows="5" placeholder="Feedback" cols="35"></textarea><br>               

                <br><input type="submit" name ="feedsubmit" class="btn btn-primary px-4 py-2" value="Send FeedBack">
            </form>
        </div>
